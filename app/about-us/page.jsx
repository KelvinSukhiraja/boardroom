    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p className="text-xs md:text-sm my-4 max-w-md">
            ...
            in your industry while enhancing your position in a globalized
            changing competitive world, focusing on some interconnected societal
            and business challenges around global risks, sustainability and
      ...
      <div className="bg-white text-black flex flex-col px-5 md:px-14 pt-14 ">
        <motion.div
          ...
          className="invisible md:visible "
        >
          <img src={"/line.svg"} width={400} height={0} className="md:my-16" />
        </motion.div>
        <motion.div
          variants={fadeIn}
          initial="initial"
